...
class NewOperation(QWidget):
    def __init__(self, operation, parent=None):
        ...
        self.connect(self.ui.restorePB, pyqtSignal("clicked()"), self.parent.takeBack)
        self.connect(self.ui.detailsPB, pyqtSignal("clicked()"), self.parent.loadDetails)
        self.connect(self.ui.planPB, pyqtSignal("clicked()"), self.parent.loadPlan)
